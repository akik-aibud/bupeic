          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {executives.map((member, i) => (
              <motion.div
                ...
                className="flex flex-col items-center rounded-xl border border-border bg-white p-6 text-center shadow-[0_2px_8px_rgba(0,0,0,0.04)]"
              >
                ...
                <Badge
                  variant="outline"
                  className="mt-2 border-primary/20 bg-primary/5 text-primary"
                >
                  {member.position}
                </Badge>
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {committeeMembers.map((member, i) => (
                <motion.div
                  ...
                  className="flex flex-col items-center rounded-xl border border-border bg-white p-5 text-center shadow-[0_2px_8px_rgba(0,0,0,0.04)]"
                >
                  ...
                  <Badge
                    variant="outline"
                    className="mt-1.5 border-primary/20 bg-primary/5 text-xs text-primary"
                  >
                    {member.position}
                  </Badge>
