    ...
    <section className="relative overflow-hidden bg-primary py-14 sm:py-20">
      ...
      <div className="relative mx-auto max-w-3xl px-4 text-center sm:px-6">
        <motion.h2
          ...
          className="text-2xl font-bold tracking-tight text-primary-foreground sm:text-3xl md:text-4xl"
        >
          Ready to Innovate?
        </motion.h2>
        ...
        <motion.p
          ...
          className="mx-auto mt-3 max-w-xl text-sm leading-relaxed text-primary-foreground/80 sm:mt-4 sm:text-base md:text-lg"
        >
